...
//converting response to http string (this satisfy here **)
...
mod tests {
    ...
    fn test_response_struct_creation_200() {
        let response_actual =
            HttpResponse::new("200", None, Some("Item was shiped on 21st Dec 2020".into()));
        let response_expected = HttpResponse {
            ...
            body: Some("Item was shiped on 21st Dec 2020".into()),
        };
    ...
    #[test]
    fn test_http_resposse_creation() {
        let response_expected = HttpResponse {
            version: "HTTP/1.1",
            status_code: "404",
            status_text: "Not Found",
